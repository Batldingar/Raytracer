...
*/
        ...
        camera.rotate(new Rotation(4f, 0, 1, 0));

        computeProgram.useProgram();

        computeProgram.setUniforms(frameBuffer[0], StateManager.getWidth()*MSAA, StateManager.getHeight()*MSAA, invertedViewProjectionMatrix, invertedViewMatrix, cubeList, sphereList); // width and height must be powers of two
