...
public class SceneD implements Scene {
    ...
    public void onSurfaceCreated(Context context) {
        ...
        // Cubes
        cube1 = new Cube(new Vector(-9.0f, 0.0f, -4.0f), new Vector(-9.2f, 4.0f, 4.0f), new Vector(0.0f, 0.0f, 0.0f), Cube.Material.METAL, 1.0f);
        cube2 = new Cube(new Vector(9.0f, 0.0f, -4.0f), new Vector(9.2f, 4.0f, 4.0f), new Vector(0.0f, 0.0f, 0.0f), Cube.Material.METAL, 1.0f);
        cube3 = new Cube(new Vector(-4.0f, 0.0f, -4.0f), new Vector(4.0f, -0.1f, 4.0f), new Vector(0.3f, 0.7f, 0.9f), Cube.Material.METAL, 1.0f);
    ...
    public void onDrawFrame() {
        ...
        sphere1.setCenter(Vector.add(sphere1.getCenter(), sphere2Speed));
