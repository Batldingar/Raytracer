...
public class SceneA implements Scene {
    ...
    public void onSurfaceCreated(Context context) {
        ...
        // Spheres
        sphere1 = new Sphere(new Vector(1.0f, 0.5f, 0.0f), 0.5f, new Vector(0.0f, 1.0f, 0.0f), Sphere.Material.METAL, 0.2f);
        sphere2 = new Sphere(new Vector(-1.0f, 0.5f, 0.0f), 0.5f, new Vector(1.0f, 0.0f, 1.0f), Sphere.Material.METAL, 0.2f);
